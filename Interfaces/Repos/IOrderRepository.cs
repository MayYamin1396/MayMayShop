...
namespace MayMayShop.API.Interfaces.Repos
{
    public interface IOrderRepository
    {
        ...
        Task<ResponseStatus> UpdateOrderStatus(UpdateOrderStatusRequest request, int currentUserLogin);
        Task<ResponseStatus> UpdatePaymentStatus(UpdatePaymentStatusRequest request, int currentUserLogin,string token);
        ...
        Task<ResponseStatus> SellerOrderCancel(OrderCancelRequest request, int currentUserLogin);
        Task<ResponseStatus> BuyerOrderCancel(OrderCancelRequest request, int currentUserLogin,string token);
        Task<ResponseStatus> ChangeDeliveryAddress(ChangeDeliveryAddressRequest request);
        Task<ResponseStatus> PaymentAgain(PaymentAgainRequest request, int currentUserLogin);
        Task<ResponseStatus> PaymentApprove(PaymentApproveRequest request, int currentUserLogin);        
